function [f_handle,Stats,c] = GiveMeFit(xData,yData,fitType,weightMeasure,suppressFigure)
% ------------------------------------------------------------------------------
...
elseif any(~goodBoth)
    ...
    if nargin>=4
    weightMeasure = weightMeasure(goodBoth); 
    end
...
case 'exp'
    s = fitoptions('Method','NonlinearLeastSquares','StartPoint',[1,0.5,0], 'Weights', weightMeasure);
