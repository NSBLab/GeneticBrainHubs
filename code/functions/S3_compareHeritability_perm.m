function [heritMatrix, nodeData, groupAdjlog] = S3_compareHeritability_perm(plotOptions, plotWhat, numPerm)
 % indTOP, mask
 if nargin <2
     plotWhat = 'Afactor';
 end
...
getMaxVal = RichClubHuman_permutation(groupAdjlog,heritMatrix, nodeData,'right', whatDistribution, colorOut, colorIn, numPerm);
